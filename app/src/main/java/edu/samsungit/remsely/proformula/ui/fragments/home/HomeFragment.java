package edu.samsungit.remsely.proformula.ui.fragments.home;
...
//            Navigation.findNavController(v).navigate(R.id.action_navigation_home_to_notificationsSettingsFragment);
            Toast.makeText(getContext(), "Уведомления будут добавлены в следующих обновлениях!", Toast.LENGTH_SHORT).show();
        });
    }

    public void navigateToGrandPrixResults(){
        mOpenGrandPrixResultsFragment.setOnClickListener((View.OnClickListener) v -> Navigation.
                findNavController(v).
